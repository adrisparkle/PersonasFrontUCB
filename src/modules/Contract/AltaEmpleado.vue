                ...
                <!--form @submit.prevent="create"-->
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <input type="text" placeholder="Documento de identidad" class="form-control" v-model="formData.Document">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        ...
                        <small v-if="formError.Ext" class="form-text text-muted text-danger">*Selecciona un valor.</small>
                      </div>
                    </div>
                    </template>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      <label>Nombres</label>
                      <div>
                        <input type="text" placeholder="Nombres" class="form-control" v-model="formData.Names">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <input type="text" placeholder="Primer Apellido" class="form-control" v-model="formData.FirstSurName">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <div>
                        <input type="text" placeholder="Segundo Apellido" class="form-control" v-model="formData.SecondSurName">
                    ...
                    <template v-if="formData.Gender==='F'">
                      <template v-if="formData.UseMariedSurName">
                        <div class="form-group col-md-4">
                          ...
                          <div>
                            <input type="text" placeholder="Apellido de Casada" class="form-control" v-model="formData.MariedSurName">
